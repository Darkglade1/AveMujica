...
namespace AveMujica.AveMujicaCode.Rewards;
    ...
    Player player) : CustomReward(player)
{
    ...
    private static string RewardIcon => "card_reward_enchantment.png".EnchantmentPath();
    ...
    public override LocString Description
    {
        get
        {
            var desc = new LocString("gameplay_ui", "AVEMUJICA-COMBAT_REWARD_ENCHANT");
