...
public class Melody() : AveMujicaCard(1,
    ...
    TargetType.Self)
{
    ...
    protected override async Task OnPlay(
        ...
        CardPlay play)
    {
        await PowerCmd.Apply<MelodyPower>(choiceContext, Owner.Creature, DynamicVars["MelodyPower"].BaseValue, Owner.Creature, this);
    }
